...
@Component({
  selector: 'app-table-registers-dashboard-doctor',
  templateUrl: './table-registers-dashboard-doctor.component.html',
  styleUrls: ['./table-registers-dashboard-doctor.component.css']
})
export class TableRegistersDashboardDoctorComponent implements OnInit {
