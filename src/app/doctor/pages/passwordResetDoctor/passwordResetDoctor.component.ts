...
@Component({
  selector: 'app-passwordResetDoctor',
  templateUrl: './passwordResetDoctor.component.html',
  styleUrls: ['./passwordResetDoctor.component.css']
})
export class PasswordResetDoctorComponent implements OnInit {
