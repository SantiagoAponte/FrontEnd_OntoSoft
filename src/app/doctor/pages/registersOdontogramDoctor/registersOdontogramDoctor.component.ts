...
@Component({
  selector: 'app-registersOdontogramDoctor',
  templateUrl: './registersOdontogramDoctor.component.html',
  styleUrls: ['./registersOdontogramDoctor.component.css']
})
export class RegistersOdontogramDoctorComponent implements OnInit {
  public tableProps = {
    // title: 'Registros',
    firstColum: 'Id',
    secondColum: 'Fecha',
