...
@Component({
  selector: 'app-resetPasswordPatient',
  templateUrl: './resetPasswordPatient.component.html',
  styleUrls: ['./resetPasswordPatient.component.css']
})
export class ResetPasswordPatientComponent implements OnInit {
