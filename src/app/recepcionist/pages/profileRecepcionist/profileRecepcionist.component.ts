...
@Component({
  selector: 'app-profileRecepcionist',
  templateUrl: './profileRecepcionist.component.html',
  styleUrls: ['./profileRecepcionist.component.css']
})
export class ProfileRecepcionistComponent implements OnInit {
  public detailsUser = [];
